...
public class MessageArgument implements SignedArgument<MessageArgument.Message> {
    ...
    public record Message(String text, MessageArgument.Part[] parts) {
        private Component resolveComponent(CommandSourceStack sender) throws CommandSyntaxException {
            return this.toComponent(sender, net.neoforged.neoforge.common.CommonHooks.canUseEntitySelectors(sender));
        }
                ...
                while (true) {
                    ...
                    if (reader.peek() == '@') {
                        ...
                        try {
                            ...
                            if (ex.getType() != EntitySelectorParser.ERROR_MISSING_SELECTOR_TYPE
                                && ex.getType() != EntitySelectorParser.ERROR_UNKNOWN_SELECTOR_TYPE) {
                                throw ex;
                            }
