...
public class DataFixers {
    ...
    public static CompletableFuture<?> optimize(Set<TypeReference> typesToOptimize) {
        ...
        Executor executor = Executors.newSingleThreadExecutor(
            new ThreadFactoryBuilder().setNameFormat("Datafixer Bootstrap #%d").setDaemon(true).setPriority(1).build()
        );
    ...
    private static void addFixers(DataFixerBuilder fixerUpper, FileFixerUpper.Builder fileFixerUpper) {
        ...
        fixerUpper.addFixer(new net.neoforged.neoforge.common.data.fixes.NeoForgeEntityLegacyAttributesFix(
        ...
        fixerUpper.addFixer(new AttributesRenameLegacy(
                neoSchema3804,
