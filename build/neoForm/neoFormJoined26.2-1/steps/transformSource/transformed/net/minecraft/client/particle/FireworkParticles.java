...
public class FireworkParticles {
    ...
    public static class OverlayParticle extends SingleQuadParticle {
        public OverlayParticle(ClientLevel level, double x, double y, double z, TextureAtlasSprite sprite) {
    ...
    private static class SparkParticle extends SimpleAnimatedParticle {
        ...
        public SparkParticle(ClientLevel level, double x, double y, double z, double xa, double ya, double za, ParticleEngine engine, SpriteSet sprites) {
    ...
    public static class Starter extends NoRenderParticle {
        ...
        public void tick() {
            ...
            if (this.life % 2 == 0 && this.life / 2 < this.explosions.size()) {
                ...
                var factory = net.neoforged.neoforge.client.FireworkShapeFactoryRegistry.get(explosion.shape());
                if (factory != null)
                    factory.build(this, trail, twinkle, colors.toIntArray(), fadeColors.toIntArray());
                else
        ...
        public void createParticleBall(double baseSpeed, int steps, IntList rgbColors, IntList fadeColors, boolean trail, boolean twinkle) {
            double xx = this.x;
            double yy = this.y;
            double zz = this.z;
        ...
        public void createParticleBurst(IntList rgbColors, IntList fadeColors, boolean trail, boolean twinkle) {
