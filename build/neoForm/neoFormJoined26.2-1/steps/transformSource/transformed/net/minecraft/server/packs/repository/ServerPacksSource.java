...
public class ServerPacksSource extends BuiltInPackSource {
    ...
    public static PackRepository createPackRepository(Path datapackDir, DirectoryValidator validator) {
        final PackRepository packRepository = new PackRepository(new ServerPacksSource(validator), new FolderRepositorySource(datapackDir, PackType.SERVER_DATA, PackSource.WORLD, validator));
    ...
    public static PackRepository createVanillaTrustedRepository() {
        final PackRepository packRepository = new PackRepository(new ServerPacksSource(new DirectoryValidator(path -> true)));
