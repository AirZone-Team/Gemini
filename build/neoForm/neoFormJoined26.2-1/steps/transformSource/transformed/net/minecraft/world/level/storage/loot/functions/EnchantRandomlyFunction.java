...
public class EnchantRandomlyFunction extends LootItemConditionalFunction {
    ...
    private EnchantRandomlyFunction(
        List<LootItemCondition> predicates, Optional<HolderSet<Enchantment>> options, boolean onlyCompatible, boolean includeAdditionalCostComponent
    ) {
        super(predicates);
    ...
    public ItemStack run(ItemStack itemStack, LootContext context) {
        ...
        Stream<Holder<Enchantment>> compatibleEnchantmentsStream = this.options
            ...
            .filter(candidate -> !shouldCheckCompatibility || itemStack.supportsEnchantment(candidate)); // Neo: Respect IItemExtension#supportsEnchantment
    ...
    public static class Builder extends LootItemConditionalFunction.Builder<EnchantRandomlyFunction.Builder> {
        ...
        public EnchantRandomlyFunction.Builder withOptions(HolderSet<Enchantment> enchantments) {
            this.options = Optional.of(enchantments);
            return this;
        }
