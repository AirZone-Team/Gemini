...
public class ServerStatusPacketListenerImpl implements ServerStatusPacketListener {
    ...
    private final @org.jspecify.annotations.Nullable String statusCache; // FORGE: cache status JSON
    ...
    public ServerStatusPacketListenerImpl(ServerStatus status, Connection connection, @org.jspecify.annotations.Nullable String statusCache) {
        this.status = status;
