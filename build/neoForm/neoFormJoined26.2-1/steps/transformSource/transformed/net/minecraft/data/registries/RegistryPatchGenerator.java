    ...
    public static CompletableFuture<RegistrySetBuilder.PatchedRegistries> createLookup(
        ...
        return vanilla.thenApply(
            parent -> {
                ...
                net.neoforged.neoforge.registries.DataPackRegistriesHooks.getDataPackRegistriesWithDimensions().forEach(registryData -> registryData.runWithArguments(cloner::addCodec));
