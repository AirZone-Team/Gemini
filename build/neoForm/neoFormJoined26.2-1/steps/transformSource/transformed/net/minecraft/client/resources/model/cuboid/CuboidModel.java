...
public record CuboidModel(
    ...
    it.unimi.dsi.fastutil.ints.Int2ObjectMap<net.neoforged.neoforge.client.model.ExtraFaceData> itemLayerFaceData
    ...
    public CuboidModel(
        ...
        this(geometry, guiLight, ambientOcclusion, transforms, textureSlots, parent, null, java.util.Map.of(), it.unimi.dsi.fastutil.ints.Int2ObjectMaps.emptyMap());
    }
    ...
    public void fillAdditionalProperties(net.minecraft.util.context.ContextMap.Builder propertiesBuilder) {
        ...
        net.neoforged.neoforge.client.model.NeoForgeModelProperties.fillItemLayerFaceData(propertiesBuilder, this.itemLayerFaceData);
    }
    ...
    public static class Deserializer implements JsonDeserializer<CuboidModel> {
        public CuboidModel deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
            ...
            var itemLayerFaceData = net.neoforged.neoforge.client.model.NeoForgeModelProperties.deserializeItemLayerFaceData(object);
            return new CuboidModel(elements, guiLight, hasAmbientOcclusion, transforms, textureMap, parentLocation, rootTransform, partVisibility, itemLayerFaceData);
        }
