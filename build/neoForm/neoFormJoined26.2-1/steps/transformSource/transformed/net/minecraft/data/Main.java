...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (!optionSet.has(helpOption) && optionSet.hasOptions()) {
            ...
            net.neoforged.neoforge.data.loading.DatagenModLoader.begin(mods, output, input, existingPacks, dev, reports, validate, isFlat, uncached, () -> {},
                    net.neoforged.neoforge.data.event.GatherDataEvent.Server::new, generator, packConsumer -> {});
        } else {
