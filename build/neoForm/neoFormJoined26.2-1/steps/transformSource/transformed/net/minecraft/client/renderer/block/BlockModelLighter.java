...
public class BlockModelLighter {
    ...
    protected static final ThreadLocal<BlockModelLighter.Cache> CACHE = ThreadLocal.withInitial(BlockModelLighter.Cache::new);
    public static final int CHECK_LIGHT = -1;
    protected final BlockModelLighter.Cache cache;
    ...
    protected final float[] faceShape = new float[BlockModelLighter.SizeInfo.COUNT];
    ...
    public enum AdjacencyInfo {
        ...
        AdjacencyInfo(
            ...
            BlockModelLighter.SizeInfo[] vert0Weights,
            BlockModelLighter.SizeInfo[] vert1Weights,
            BlockModelLighter.SizeInfo[] vert2Weights,
            BlockModelLighter.SizeInfo[] vert3Weights
        ) {
        ...
        public static BlockModelLighter.AdjacencyInfo fromFacing(Direction direction) {
    ...
    private enum AmbientVertexRemap {
        ...
        public static BlockModelLighter.AmbientVertexRemap fromFacing(Direction direction) {
            return BY_FACING[direction.get3DDataValue()];
        }
    }
