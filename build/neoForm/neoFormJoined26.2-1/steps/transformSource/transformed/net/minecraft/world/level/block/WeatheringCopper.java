...
public interface WeatheringCopper extends ChangeOverTimeBlock<WeatheringCopper.WeatherState> {
    ...
    static Block getFirst(Block block) {
        ...
        for (Block previous = net.neoforged.neoforge.common.DataMapHooks.getPreviousOxidizedStage(block); previous != null; previous = net.neoforged.neoforge.common.DataMapHooks.getPreviousOxidizedStage(previous)) {
            candiate = previous;
        }
    ...
    enum WeatherState implements StringRepresentable {
        ...
        public static void forEach(Consumer<WeatheringCopper.WeatherState> consumer) {
