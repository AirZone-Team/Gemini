...
public interface Aquifer {
    ...
    static Aquifer createDisabled(Aquifer.FluidPicker fluidRule) {
        return new Aquifer() {
            @Override
    ...
    class NoiseBasedAquifer implements Aquifer {
        ...
        protected static double similarity(int distanceSqr1, int distanceSqr2) {
            double threshold = 25.0;
            return 1.0 - (distanceSqr2 - distanceSqr1) / 25.0;
        }

        private double calculatePressure(
            DensityFunction.FunctionContext context, MutableDouble barrierNoiseValue, Aquifer.FluidStatus statusClosest1, Aquifer.FluidStatus statusClosest2
        ) {
            int posY = context.blockY();
        ...
        private int computeSurfaceLevel(
            int x, int y, int z, Aquifer.FluidStatus globalFluid, int lowestPreliminarySurface, boolean surfaceAtCenterIsUnderGlobalFluidLevel
        ) {
