...
public interface Recipe<T extends RecipeInput> {
    ...
    interface BookInfo<CategoryType> {
        ...
        static <CategoryType, SelfType extends Recipe.BookInfo<CategoryType>> MapCodec<SelfType> mapCodec(
            Codec<CategoryType> categoryCodec, CategoryType defaultCategory, Recipe.BookInfo.Constructor<CategoryType, SelfType> constructor
        ) {
        ...
        static <CategoryType, SelfType extends Recipe.BookInfo<CategoryType>> StreamCodec<RegistryFriendlyByteBuf, SelfType> streamCodec(
            StreamCodec<? super RegistryFriendlyByteBuf, CategoryType> categoryCodec, Recipe.BookInfo.Constructor<CategoryType, SelfType> constructor
        ) {
