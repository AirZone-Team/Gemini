...
public class MapItemSavedData extends SavedData {
    ...
    public static MapItemSavedData createFresh(
        double originX, double originY, byte scale, boolean trackingPosition, boolean unlimitedTracking, ResourceKey<Level> dimension
    ) {
    ...
    public void addDecoration(
        Holder<MapDecorationType> type, @Nullable LevelAccessor level, String key, double xPos, double zPos, double yRot, @Nullable Component name
    ) {
    ...
    private MapItemSavedData.@Nullable MapDecorationLocation calculateDecorationLocationAndType(
        Holder<MapDecorationType> type, @Nullable LevelAccessor level, double yRot, float xDeltaFromCenter, float yDeltaFromCenter
    ) {
