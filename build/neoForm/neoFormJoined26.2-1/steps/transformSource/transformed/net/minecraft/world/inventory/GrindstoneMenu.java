...
public class GrindstoneMenu extends AbstractContainerMenu {
    ...
    public GrindstoneMenu(int containerId, Inventory inventory, ContainerLevelAccess access) {
