...
public abstract class AbstractFurnaceMenu extends RecipeBookMenu {
    ...
    protected AbstractFurnaceMenu(
        MenuType<?> menuType, ResourceKey<RecipePropertySet> allowedInputs, RecipeBookType recipeBookType, int containerId, Inventory inventory
    ) {
    ...
    protected boolean isFuel(ItemStack itemStack) {
        var recipeType = switch (recipeBookType) {
        ...
        return itemStack.getBurnTime(recipeType, this.level.fuelValues()) > 0;
    }
    ...
    public RecipeBookMenu.PostPlaceAction handlePlacement(
        boolean useMaxItems, boolean allowDroppingItemsToClear, RecipeHolder<?> recipe, ServerLevel level, Inventory inventory
    ) {
