...
import net.neoforged.neoforge.client.extensions.ITexturedModelExtension.ProviderExtension;

@OnlyIn(Dist.CLIENT)
public class TexturedModel implements ITexturedModelExtension {
    ...
    public static TexturedModel.Provider createDefault(Function<Block, TextureMapping> mapping, ModelTemplate template) {
    ...
    @FunctionalInterface
    public interface Provider extends ProviderExtension {
