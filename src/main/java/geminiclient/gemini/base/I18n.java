...
public final class I18n {
    ...
    static {
        ...
        pair("max", "最大", "max");
        pair("4K Rhythm Game", "4K 节奏游戏", "4K Rhythm Game");
        ...
        pair("No playable 4K map in this .osz", "此 .osz 中没有可游玩的 4K 谱面", "No playable 4K map in this .osz");
        ...
        pair("[%s] is a %dK map, only 4K is supported", "[%s] 是 %dK 谱面，仅支持 4K", "[%s] is a %dK map, only 4K is supported");
