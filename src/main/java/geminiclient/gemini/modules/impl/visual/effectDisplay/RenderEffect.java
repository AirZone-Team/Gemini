...
public class RenderEffect {
    ...
    public void render(GuiGraphics graphics) {
        ...
        this.infos.entrySet().removeIf(entry -> {
            ...
            if (info.durationTimer.value > 0) {
                graphics.fill(2, 2, (int) info.durationTimer.value, (int) HEIGHT - 2,
                        new Color(50, 50, 50, 150).getRGB());
            }
            ...
            // 向左对齐，从装饰条右侧开始绘制
            graphics.drawString(mc.font, duration, (int) (14 / 0.6F), (int) (17.0F / 0.6F), Color.WHITE.getRGB(),
                    false);
            graphics.pose().popMatrix();
    ...
    private Component getDisplayName(MobEffect effect, MobEffectInfo info) {
        ...
        if (info.amplifier >= 1 && info.amplifier <= 3) {
            amplifierName = " " + net.minecraft.locale.Language.getInstance()
                    .getOrDefault("enchantment.level." + (info.amplifier + 1));
