 ...
 * lists every playable 4K difficulty, and offers entry to keybinds.
 *
...
public final class Osu4kSelectScreen extends Osu4kScreen {
    ...
    private void refreshFromCurrentArchive() {
        ...
        if (playable.isEmpty()) {
            ...
            errorText = I18n.tr("No playable 4K map in this .osz") + "\n" + String.join("\n", reasons);
            maps = List.of();
            setTitle = "";
        } else {
            maps = playable;
    ...
    private void openKeybinds() {
        this.minecraft.gui.setScreen(new Osu4kKeybindScreen(this));
    }
    ...
    public void extractRenderState(GuiGraphicsExtractor gui, int mouseX, int mouseY, float partialTicks) {
        ...
        String subtitle = setTitle.isEmpty() ? I18n.tr("4K Rhythm Game") : setTitle;
